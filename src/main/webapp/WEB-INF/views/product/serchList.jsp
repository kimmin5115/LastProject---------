...
<div class="container">
				...
				<!-- Product Single -->
				<div id="contend">
				<c:forEach var="serchList" items="${list}">
				<div class="col-md-3 col-sm-6 col-xs-6" style=" height: 460px;">
					<div class="product product-single">
						<div class="product-thumb" >
							<button class="main-btn quick-view" onclick="location.href='productView?number=${serchList.productno}'"><i class="fa fa-search-plus"></i> 상세보기</button>
							<img src="${pageContext.request.contextPath}/resources/fileupload/${serchList.photo1}" alt="" style="width:270px; height: 270px;">
						</div>
						<div class="product-body">
							<h3 class="product-price"><fmt:formatNumber value="${serchList.price}" pattern="#,###.##"/>원</h3>
							<h2 class="product-name"><a href="#">${serchList.trade_name}</a></h2>
							<h5 style="color:#999">조회수 : ${serchList.hit }</h5>

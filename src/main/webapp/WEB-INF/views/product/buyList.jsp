...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div class="contLeft" style=" ">
					<div >
                          <table class="table" id="table">
							    ...
							    <c:forEach var="result" items="${buyList }" varStatus="status">
								 <tr>
								    <td>
								    ...
								    <td>
								    <c:if test="${result.result==1}">
								   	 <button style="font-size: 12px;padding:0; ">배송취소하기</button>
								    </c:if>
								    <c:if test="${result.result==2}">
								    	<button style="font-size: 12px;padding:0; ">리뷰쓰기</button>
								    	<button style="font-size: 12px;padding:0; ">반품신청</button>
								    </c:if>
								    <c:if test="${result.result==3}">
			...
			<!-- 목록ㄱㄱㄱㄱㄱㄱㄱㄱㄱㄱ -->
			 <c:forEach var="result" items="${buyCartList }" varStatus="status">
			<div class="col-md-12" style="background-color:white; margin-bottom:30px; padding:30px 15px; border:1px solid" id="count${status.index}">

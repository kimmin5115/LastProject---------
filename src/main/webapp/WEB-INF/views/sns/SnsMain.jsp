			...
			$.ajax({
				...
				success:function(result){
					if(result=="add"){
						...
						var output = '<div class="col-md-2"><button class="divisionFriend">친구신청</button></div>';
						$(".addFriendBtn"+idx).html(output);
					}
				},
				error:function(){
...
<body>
	...
	<div class="category-nav" style="width:330px; height:600px; margin-top:10px;">
		...
		<a href=""><span class="category-header"><img style="border: 3px solid gold; border-radius: 50%; -moz-border-radius: 7px; -khtml-border-radius: 7px; -webkit-border-radius: 7px;" width="50px" height="50px" src="${pageContext.request.contextPath}/resources/profilepic/${member.profile}">${member.name}</span></a>
